...
const _ = require('lodash'),
  ...
  deviceCategories = require('./deviceCategories'),
  ...
  getDeviceDescription = (deviceCategory, deviceSubcategory) =>
    deviceCategories[deviceCategory] &&
    deviceCategories[deviceCategory].subcategories[deviceSubcategory],
...
extendedData('0300', 'Product Data Response', ({command, response}) => {
  ...
  command.deviceDescription = deviceDescription.deviceDescription;
  command.modelNumber = deviceDescription.modelNumber;
  return command;
});
