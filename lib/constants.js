...
const X10_COMMANDS = [
  ...
  ALL_LINK_CODES = Object.entries(ALL_LINK_TYPES).reduce(
  ...
  ALL_LINK_CONTROL_CODES = Object.entries(ALL_LINK_CONTROL_NAMES).reduce(
  ...
  OUTLET_CODES = Object.entries(OUTLET_NAMES).reduce(
