...
module.exports = {
  ...
  // The regexp pattern or array of patterns that Jest uses to detect
  // test files
  // testRegex: [],
  ...
  // Setting this value to 'fake' allows the use of fake timers for
  ...
  // An array of regexp pattern strings that are matched against all
  // modules before the module loader will automatically return a mock
  // for them
